...
public class MovieLibrary {
    ...
    public void fillMovieList(){
        ...
        movieLibrary.add(new Movie("Gladiator",r_Scott, List.of(r_Crowe, j_Deep)));
        movieLibrary.add(new Movie("Pirates of the Caribbean",g_Verbinski, List.of(o_Reed, j_Deep)));
        movieLibrary.add(new Movie("Pulp Fiction",q_Tarantino, List.of(j_Travolta, u_Thurman)));
        movieLibrary.add(new Movie("Hobbit - An Unexpected Jorney",r_Scott, List.of(k_Knightley, d_Jacob)));
        movieLibrary.add(new Movie("Poranek Kojota",p_Jackson, List.of(r_Crowe, o_Bloom)));
        movieLibrary.add(new Movie("Transformers",q_Tarantino, List.of(r_Crowe, d_Jacob)));
        movieLibrary.add(new Movie("Top Gun",r_Scott, List.of(r_Crowe, t_Cruze)));
        movieLibrary.add(new Movie("Desperado",r_Scott, List.of(r_Crowe, o_Bloom)));
        movieLibrary.add(new Movie("Mission Impossible",p_Jackson, List.of(r_Crowe, t_Cruze)));
        movieLibrary.add(new Movie("Forest Gump",g_Verbinski, List.of(o_Reed, h_Keitel)));
    }

    public MovieLibrary(Movie[] movies) {
        movieLibrary = new ArrayList<>(Arrays.asList(movies));
    }
    ...
    public void getRandomMovieInformation() {
        System.out.println(movieLibrary.get(RandomDataProvider.getRandomMovieIndex()));
    }
